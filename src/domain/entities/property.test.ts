...
describe("Property Entity", () => {
    it("deve cirar uma instância de Property com todos os atributos", () => {
    ...
    it("não deve aplicar desconto para etadias menores que 7 noites", () => {
    ...
    it("não deve aplicar desconto para estadias de 7 noites", () => {
        const property = new Property("1", "Apartamento", "Descrição", 5, 100);
